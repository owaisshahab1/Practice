<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_User.aspx.cs" Inherits="Update_User" %>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td></td><td style="border:1px solid Black">Password</td><td style="border:1px solid Black;" class="TextBox">
                            <asp:TextBox ID="tb_password" Width="200px" TextMode="SingleLine" runat="server" ></asp:TextBox>
                                                                                 </td><td>
                      ...
                      <tr>
                        <td></td><td style="border:1px solid Black">Confirm Password</td><td style="border:1px solid Black;" class="TextBox">
                            <asp:TextBox ID="tb_ConfrmPassword" Width="200px" TextMode="SingleLine" runat="server" ></asp:TextBox>
                                                                                         </td><td>
